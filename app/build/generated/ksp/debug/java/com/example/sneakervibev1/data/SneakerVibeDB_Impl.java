...
import com.example.sneakervibev1.data.dao.CategoriaDao_Impl;
...
public final class SneakerVibeDB_Impl extends SneakerVibeDB {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashSet<TableInfo.Index> _indicesCategoria = new HashSet<TableInfo.Index>(1);
        _indicesCategoria.add(new TableInfo.Index("index_categoria_nombre_categoria", true, Arrays.asList("nombre_categoria"), Arrays.asList("ASC")));
        ...
        _indicesProducto.add(new TableInfo.Index("index_producto_id_categoria", false, Arrays.asList("id_categoria"), Arrays.asList("ASC")));
